...
public static class AMACurves
{
    ...
    public static CurveDelegate GetCurveFunction(Curves _curve)
    {
        switch (_curve)
        {
            case Curves.ExpoEaseInOut:
                return ExpoEaseInOut;
            case Curves.ExpoEaseOut:
                return ExpoEaseOut;
            case Curves.ExpoEaseIn:
                return ExpoEaseIn;
            case Curves.ExpoEaseOutIn:
                return ExpoEaseOutIn;
            case Curves.CircEaseOut:
                return CircEaseOut;
            case Curves.CircEaseIn:
                return CircEaseIn;
            case Curves.CircEaseInOut:
                return CircEaseInOut;
            case Curves.CircEaseOutIn:
                return CircEaseOutIn;
            case Curves.QuadEaseOut:
                return QuadEaseOut;
            case Curves.QuadEaseIn:
                return QuadEaseIn;
            case Curves.QuadEaseInOut:
                return QuadEaseInOut;
            case Curves.QuadEaseOutIn:
                return QuadEaseOutIn;
            case Curves.SineEaseOut:
                return SineEaseOut;
            case Curves.SineEaseIn:
                return SineEaseIn;
            case Curves.SineEaseInOut:
                return SineEaseInOut;
            case Curves.SineEaseOutIn:
                return SineEaseOutIn;
            case Curves.CubicEaseOut:
                return CubicEaseOut;
            case Curves.CubicEaseIn:
                return CubicEaseIn;
            case Curves.CubicEaseInOut:
                return CubicEaseInOut;
            case Curves.CubicEaseOutIn:
                return CubicEaseOutIn;
            case Curves.QuartEaseIn:
                return QuartEaseIn;
            case Curves.QuartEaseOut:
                return QuartEaseOut;
            case Curves.QuartEaseInOut:
                return QuartEaseInOut;
            case Curves.QuartEaseOutIn:
                return QuartEaseOutIn;
            case Curves.QuintEaseIn:
                return QuintEaseIn;
            case Curves.QuintEaseOut:
                return QuintEaseOut;
            case Curves.QuintEaseInOut:
                return QuintEaseInOut;
            case Curves.QuintEaseOutIn:
                return QuintEaseOutIn;
            case Curves.ElasticEaseIn:
                return ElasticEaseIn;
            case Curves.ElasticEaseOut:
                return ElasticEaseOut;
            case Curves.ElasticEaseInOut:
                return ElasticEaseInOut;
            case Curves.ElasticEaseOutIn:
                return ElasticEaseOutIn;
            case Curves.BounceEaseIn:
                return BounceEaseIn;
            case Curves.BounceEaseOut:
                return BounceEaseOut;
            case Curves.BounceEaseInOut:
                return BounceEaseInOut;
            case Curves.BounceEaseOutIn:
                return BounceEaseOutIn;
            case Curves.BackEaseIn:
                return BackEaseIn;
            case Curves.BackEaseOut:
                return BackEaseOut;
            case Curves.BackEaseInOut:
                return BackEaseInOut;
            case Curves.BackEaseOutIn:
